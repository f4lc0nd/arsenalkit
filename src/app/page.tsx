...
export default function Home() {
  return (
    <div className=" flex flex-row min-h-screen justify-center items-center">
      <div className="flex flex-row min-h-screen justify-center items-center bg-gradient-to-br from-[#05070a] via-[#0c0e14] to-[#121620] text-white py-16">
        <div className="container mx-auto px-4 py-16 relative z-10 max-w-4xl text-center">
          ...
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute top-0 left-0 min-w-full min-h-full  opacity-10 bg-[linear-gradient(45deg,rgba(29,233,182,0.1)_0%,rgba(29,233,182,0)_70%)] animate-pulse"></div>
